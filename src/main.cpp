...
unsigned int nTargetSpacing = 40; // 40 second block
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Purplecoin: check proof-of-stake block signature
...
// purplecoin: attempt to generate suitable proof-of-stake
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Supercharged! Revolutionary battery could see devices run for up to 50 YEARS";
        CTransaction txNew;
        txNew.nTime = 1398924178;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398924178;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 512507 : 0;
        ...
        assert(block.hashMerkleRoot == uint256("0xbee67d1230cb938a1667ff9c34b5e4d677cc6cf4410cb2e6998065becad80042"));
...
unsigned char pchMessageStart[4] = { 0x71, 0x34, 0x21, 0x04 };
